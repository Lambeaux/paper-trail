...
(deftest ^:minimal test-nested-core-fns
  (forms->test
   "Test basic core functions when nested"
...
(deftest ^:core test-common-macros
  (forms->test
   "Test common macros from clojure.core"
   (if-not (= 1 2) :hi)
   (if-not (= 1 1) :hi :bye)
   (and 1 2 3)
   (or nil nil 1)
